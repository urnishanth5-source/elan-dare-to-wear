        ...
        <div className="bg-[#12151d] border border-white/10 rounded-2xl p-6 sm:p-8 space-y-6 shadow-2xl">
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            <div>
              ...
              <input type="email" required placeholder="urnishanth5@gmail.com" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full text-xs bg-[#090a0f] text-white px-3.5 py-2.5 rounded-xl border border-white/10 focus:border-blue-500 focus:outline-none transition-colors" />
            </div>
            <div>
